...
begin
    IndexImg:= 0;
    I:= FindFirst(Caminho+Extensao, faAnyFile, DirInfo);
    while I = 0 do begin
...
begin
    ...
    if ScreenCount = 1 then begin
       ...
       LarguraScreen:= Screen.Width;
        ...
        AlturaScreen:= Screen.Monitors[1].Height;//- ChamadaFinal.Height;
        LarguraScreen:= Screen.Monitors[1].Width;
        with frmChamadaFinal do begin
             ClientHeight:= AlturaScreen-50;
